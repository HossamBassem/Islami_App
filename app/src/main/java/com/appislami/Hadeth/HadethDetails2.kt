...
class HadethDetails2:AppCompatActivity() {
//lateinit var PDFView: PDFView
  /*  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.hadeth_details2)
    ...
    fun getFile() : File{
        val inputStream = assets.open("book 2.pdf")
        return File(filesDir.absolutePath + "book 2.pdf").apply {
