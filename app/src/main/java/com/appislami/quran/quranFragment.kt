...
import com.appislami.Adpter.sura
...
lateinit var adpter: SuraNameAdpter
...
recyclerView=requireView().findViewById(R.id.recycler_view1)
        val manager = LinearLayoutManager(requireContext())
        recyclerView.layoutManager = manager
        recyclerView.setHasFixedSize(true)
        adpter = SuraNameAdpter(getSuraList())
        recyclerView.adapter = adpter
//adpter=SuraNameAdpter(getSuraList())
adpter.onItemClickLisetner=object :SuraNameAdpter.onItemClickListener{
